...
{
    add_submenu_page('tools.php', 'Informations PHP', 'PhpInfo', 'administrator', 'admin-phpinfo-page.php', 'admin_phpinfo_page', 4);
}
...
//Dans le menu Outils de l'administration WordPress, le dernier élément affiché doit être PhpInfo : cliquer dessus
